...
const SatisfactoryCard = ({ icon, value, text }) => {
 return (
  <div className="satcard group w-auto border-2 py-8 px-2 flex flex-col gap-4 items-center justify-center cursor-pointer rounded-md shadow-md hover:bg-valencia-600 hover:text-white font-inter">
