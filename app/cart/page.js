  ...
  <main>
   <section>
    ...
    <div>
     ...
     <button type="submit" onClick={()=> router.push('/')} className="px-5 py-3 border-2 hover:bg-black hover:text-white hover:scale-75 transition duration-300 ease-in text-black font-medium rounded-md">Return To Shop</button>
    </div>
   </section>
   {/* checkout section */}
   <section className="flex xs:flex-col xs:gap-10 md:flex-row justify-between font-inter items-start my-10">
     ...
     <div className="border-2 border-wild-sand-800 px-8 py-10 xs:w-auto md:w-[400px] rounded-md">
       ...
       <button type="submit" className="bg-valencia-600 text-white hover:bg-valencia-400 hover:text-black rounded-md font-medium px-6 py-3 mt-5 hover:scale-90 transition duration-300 ease-in">Proceed to checkout</button>
     </div>
   </section>
  </main>
 );
